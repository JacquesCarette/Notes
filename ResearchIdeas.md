...
- Not all records represent theories [Obvious!]. Corrolary: Representing theories as (dependent) records is lossy. What do you lose? What meta-theory your theory belongs to; and indeed what 'term', in the meta-theory you are representing. So you can only write functions on models of your theory, but not theory-level operations without resorting to meta-programming.
